...
const GAME_MANIFEST = [
  {
    ...
    description: "Travel the world through music. Hear a clip, follow the rhythm, and match it to the right country on the map.",
    accent: "#FF4EAB",
    emoji: "🎵",
    image: "/characters/horns-jaime-jeff.png",
    status: "live"
  },
  {
    slug: "find-foxy",
    ...
    description: "Follow the clues, guess the country, and collect passport stamps on a world chase.",
    accent: "#3B82F6",
    emoji: "🦊",
    image: "/characters/FOX 3.png",
    status: "coming-soon"
  },
  {
    ...
    description: "Jaime and Jeff are zigzagging the globe! Pick the next city on the map and track them down before they get too far ahead.",
    accent: "#FBBF24",
    emoji: "🧭",
    image: "/characters/spaceship-jaime-jeff.png",
    status: "live"
  },
  {
    slug: "elefante",
    ...
    description: "Hop aboard Air Fante and zoom around the globe! Dodge obstacles and discover a new country with every flight.",
    accent: "#22C55E",
    emoji: "🐘",
    image: "/characters/air-fante-plane.png",
    status: "live"
  }
];
function r(e) {
...
const FULL_BLEED_ROUTES = ["/games/find-foxy", "/games/world-adventure", "/"];
function PortalShell({ children }) {
  const pathname = useRouterState({
    select: (state) => state.location.pathname
  });
  const isFullBleed = FULL_BLEED_ROUTES.includes(pathname);
  GAME_MANIFEST.find((g) => g.href === pathname) ?? null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen flex-col overflow-hidden bg-paper text-ink", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: "radial-gradient(circle at top left, rgba(255,78,171,0.18), transparent 30%), radial-gradient(circle at top right, rgba(59,130,246,0.18), transparent 28%), radial-gradient(circle at bottom center, rgba(251,191,36,0.2), transparent 30%), linear-gradient(180deg, #fffbf0 0%, #fff7e0 100%)"
        },
        children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-30 border-b-4 border-ink bg-paper/95 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-6xl items-center justify-between gap-3 pl-1 pr-3 sm:h-20 sm:pl-2 sm:pr-4 lg:pl-3 lg:pr-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex shrink-0 items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            ...
            alt: "World Tour",
            className: "h-[3.5rem] w-auto shrink-0 sm:h-[4.5rem]"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex shrink-0 items-center justify-end gap-2 overflow-x-auto py-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PortalNavLink, { href: "/", label: "Game Hub", active: pathname === "/", accent: "#22C55E" }),
        GAME_MANIFEST.map((game) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          PortalNavLink,
          {
            href: game.href,
            label: game.slug === "elefante" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/characters/air-fante.png", className: "h-4 w-auto", alt: "" }),
              game.title
            ] }) : `${game.emoji} ${game.title}`,
            active: pathname === game.href,
            accent: game.accent
          },
          game.slug
        ))
    ...
    isFullBleed ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-0 flex-1 flex-col", children }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-4 pb-12 pt-6 sm:px-6 lg:px-8", children }) })
  ] });
}
function PortalNavLink({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Link,
    {
      to: href,
      className: cn(
        "rounded-full border-[3px] border-ink px-3 py-1.5 text-xs font-extrabold transition-transform hover:-translate-y-0.5 sm:text-sm",
...
const appCss = "/assets/styles-7W5g3dId.css";
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A playful portal of world-learning games featuring music, clues, and global adventures."
      },
      { name: "author", content: "Jaime Jangles" },
      { property: "og:title", content: "Jaime Jangles World Games" },
      {
        property: "og:description",
        content: "Jump between world-learning games with shared style and direct links from Wix or anywhere else."
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@JaimeJangles" }
    ],
    links: [
      {
        rel: "stylesheet",
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PortalShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) });
}
const $$splitComponentImporter$4 = () => import("./index-CwmUGso4.js");
const Route$4 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Jaime Jangles World Games"
    }, {
      property: "og:description",
      content: "Pick a world-learning game and explore through music, clues, and story routes."
    }, {
      property: "og:image",
      content: "/art/title.png"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./world-adventure-D0C7tQ1j.js");
const Route$3 = createFileRoute("/games/world-adventure")({
  head: () => ({
    meta: [{
      title: "Find Jaime & Jeff | Jaime Jangles"
    }, {
      name: "description",
      content: "Jaime and Jeff are zigzagging the globe! Follow their clues across continents, pick the next city on the map, and track them down before they get too far ahead."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./music-match-CoEecRyW.js");
const Route$2 = createFileRoute("/games/music-match")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$1 = () => import("./find-foxy-BXQwaa-7.js");
const Route$1 = createFileRoute("/games/find-foxy")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter = () => import("./elefante-m_0iT95U.js");
const Route2 = createFileRoute("/games/elefante")({
  head: () => ({
    meta: [{
      title: "Elefante: Air Fante World Tour"
    }, {
      name: "description",
      content: "Fly Elefante through the skies and dodge obstacles on a world music tour!"
    }],
    links: [{
      rel: "icon",
      type: "image/png",
      href: "/characters/air-fante.png"
    }]
  }),
...
const GamesWorldAdventureRoute = Route$3.update({
  id: "/games/world-adventure",
  path: "/games/world-adventure",
  getParentRoute: () => Route$5
});
const GamesMusicMatchRoute = Route$2.update({
  id: "/games/music-match",
  path: "/games/music-match",
  getParentRoute: () => Route$5
});
const GamesFindFoxyRoute = Route$1.update({
  id: "/games/find-foxy",
  path: "/games/find-foxy",
  getParentRoute: () => Route$5
});
const GamesElefanteRoute = Route2.update({
  id: "/games/elefante",
  path: "/games/elefante",
  getParentRoute: () => Route$5
});
const rootRouteChildren = {
  ...
  GamesElefanteRoute,
  GamesFindFoxyRoute,
  GamesMusicMatchRoute,
  GamesWorldAdventureRoute
};
