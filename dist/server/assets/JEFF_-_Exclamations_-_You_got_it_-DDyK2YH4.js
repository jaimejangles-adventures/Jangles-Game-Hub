...
function burstFinale() {
  ...
  const frame2 = () => {
    ...
    if (Date.now() < end) requestAnimationFrame(frame2);
  };
  frame2();
}
...
function useStamps() {
  const [stamps, setStamps] = reactExports.useState(readStored);
  reactExports.useEffect(() => {
    const onStorage = (e) => {
  ...
  const addStamps = reactExports.useCallback((delta) => {
...
const exclamHurray = "/assets/JEFF_-_Exclamations_-_Hurray_-DmLgRbEH.mp3";
const exclamWayToGo = "/assets/JEFF_-_Exclamations_-_Way_to_Go_-BXxee1K9.mp3";
const exclamYouDidIt = "/assets/JEFF_-_Exclamations_-_You_did_it_-DQAc8QIn.mp3";
const exclamYouGotIt = "/assets/JEFF_-_Exclamations_-_You_got_it_-DnEx6oio.mp3";
export {
