...
export type GameManifestEntry = {
  ...
  emoji: string;
  image: string;
  /** "scene" = full-bleed cover image (rich illustration); default = character/icon with multiply blend */
  imageVariant?: "scene";
...
export const GAME_MANIFEST: GameManifestEntry[] = [
  ...
  },
  {
    ...
    accent: "#3B82F6",
    emoji: "🦊",
    image: asset("/book-pages/book3/page-04.jpg"),
    imageVariant: "scene",
    status: "coming-soon",
  ...
  },
  {
    ...
    accent: "#4ecdc4",
    emoji: "🖍️",
    image: asset("/count-backgrounds/page-12.png"),
    imageVariant: "scene",
    status: "live",
    category: "music-arts",
  },
  {
    ...
    accent: "#f97316",
    emoji: "🔢",
    image: asset("/count-backgrounds/page-3.png"),
    imageVariant: "scene",
    status: "live",
    category: "math-games",
  },
  {
    ...
    accent: "#8B5CF6",
    emoji: "🧩",
    image: asset("/count-backgrounds/page-18.png"),
    imageVariant: "scene",
    status: "live",
    category: "puzzles",
  },
  {
    ...
    accent: "#ef6c00",
    emoji: "🦊",
    image: asset("/count-backgrounds/page-8.png"),
    imageVariant: "scene",
    status: "live",
    category: "arcade-adventures",
  },
  {
    ...
    accent: "#f97316",
    emoji: "➕",
    image: asset("/count-backgrounds/page-4.png"),
    imageVariant: "scene",
    status: "live",
    category: "math-games",
  },
  ...
  },
  {
    ...
    accent: "#8B5CF6",
    emoji: "🔍",
    image: asset("/count-backgrounds/page-9.png"),
    imageVariant: "scene",
    status: "live",
    category: "puzzles",
  },
  ...
  },
  {
    ...
    accent: "#7c3aed",
    emoji: "🔐",
    image: asset("/count-backgrounds/page-22.png"),
    imageVariant: "scene",
    status: "live",
    category: "puzzles",
  },
  {
    ...
    accent: "#f97316",
    emoji: "➖",
    image: asset("/count-backgrounds/page-5.png"),
    imageVariant: "scene",
    status: "live",
    category: "math-games",
  },
  {
    ...
    accent: "#f97316",
    emoji: "✖️",
    image: asset("/count-backgrounds/page-6.png"),
    imageVariant: "scene",
    status: "live",
    category: "math-games",
  },
  ...
  },
  {
    ...
    accent: "#f97316",
    emoji: "➗",
    image: asset("/count-backgrounds/page-7.png"),
    imageVariant: "scene",
    status: "live",
    category: "math-games",
  },
  {
    ...
    accent: "#f97316",
    emoji: "🔤",
    image: asset("/count-backgrounds/page-21.png"),
    imageVariant: "scene",
    status: "live",
    category: "learning",
  },
  ...
  },
  {
    ...
    accent: "#ef6c00",
    emoji: "🦊",
    image: asset("/count-backgrounds/page-15.png"),
    imageVariant: "scene",
    status: "live",
    category: "puzzles",
  },
  {
    ...
    accent: "#FF8C00",
    emoji: "🎨",
    image: asset("/art/styleimage_a.png"),
    status: "live",
    category: "learning",
  },
  {
    ...
    accent: "#00eeff",
    emoji: "🏓",
    image: asset("/count-backgrounds/page-19.png"),
    imageVariant: "scene",
    status: "live",
    category: "arcade-adventures",
  },
  {
    ...
    accent: "#48DBFB",
    emoji: "⌨️",
    image: asset("/characters/casey-8bit.png"),
    status: "live",
    category: "learning",
  },
  {
    ...
    accent: "#C4B5FD",
    emoji: "🏛️",
    image: asset("/count-backgrounds/page-10.png"),
    imageVariant: "scene",
    status: "live",
    category: "math-games",
  },
  {
    ...
    accent: "#f59e0b",
    emoji: "💰",
    image: asset("/count-backgrounds/page-20.png"),
    imageVariant: "scene",
    status: "live",
    category: "math-games",
  },
