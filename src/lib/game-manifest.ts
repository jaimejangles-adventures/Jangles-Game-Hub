...
export const GAME_MANIFEST: GameManifestEntry[] = [
  ...
  {
    slug: "air-fante-alphabet",
    href: "/games/air-fante-alphabet",
    title: "Air Fante Alphabet",
    eyebrow: "Talk like a pilot",
    description:
      "Air Fante planes fly by showing call signs — hold the mic and read them back like a real pilot! Alpha, Bravo, Charlie… then hear your own voice crackle over the radio.",
    accent: "#38BDF8",
    emoji: "📻",
    image: asset("/characters/air-fante-plane.png"),
    status: "live",
  ...
  },
  {
    ...
    accent: "#7c3aed",
    emoji: "🔐",
    image: asset("/thumbs/mastermind.png"),
    status: "live",
    category: "puzzles",
  },
  {
  ...
  },
  {
    ...
    accent: "#ef6c00",
    emoji: "🦊",
    image: asset("/thumbs/foxy-word-scramble.png"),
    status: "live",
    category: "puzzles",
  },
  {
  ...
  },
  {
    ...
    accent: "#F43F5E",
    emoji: "🔴",
    image: asset("/thumbs/checkers.png"),
    status: "live",
    category: "puzzles",
  },
  {
